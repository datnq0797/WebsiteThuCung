...
namespace WebsiteThuCungBento.Controllers
{
    public class UserController : Controller
    {
        ...
        public void SendVerificationLinkEmail(string emailId, string activationCode, string emailFor = "ResetPassword")
        {
            ...
            var fromEmail = new MailAddress("bentoshop@outlook.com.vn", "BENTO"); //Sửa lại địa chỉ email 
            var toEmail = new MailAddress(emailId);
            var fromEmailPassword = "bentoshop"; //mật khẩu email
            string subject = "";
            string body = "";
        ...
        public void sendcontact(string Name, string Email, string Subject, string Content)
        {
            ...
            var fromEmail = new MailAddress("bentoshop@outlook.com.vn");
            var toEmail = new MailAddress(kh.EMAIL);
            var fromEmailPassword = "bentoshop"; // replace with actual password
